...
export default function HomePage() {
  ...
  />
          ...
          <nav className="flex items-center space-x-1 sm:space-x-2">
            ...
            <a href="https://wa.me/918777765887" className="flex bg-gradient-to-r from-emerald-600 to-emerald-500 text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-md hover:shadow-lg hover:from-emerald-700 hover:to-emerald-600 transition duration-150 ml-2">
